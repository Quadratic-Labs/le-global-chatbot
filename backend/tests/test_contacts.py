...
from app.services.contact_document_photos import extract_contact_photo_candidates
...
from app.services.contact_document_photos import ContactPhotoCandidate, extract_contact_photo_candidates
